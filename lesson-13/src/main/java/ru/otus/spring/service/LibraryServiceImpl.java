...
public class LibraryServiceImpl implements LibraryService {
    ...
    public String createLibraryBook(String bookTitle, List<String> authorNames, List<String> genreNames) {
        bookService.createBook(new Book(bookTitle,
                authorNames.stream().map(s -> new Author(s.trim())).collect(Collectors.toList()),
                genreNames.stream().map(s -> new Genre(s.trim())).collect(Collectors.toList())));
        return messageSource.getMessage("book.create", null, localeService.getCurrentLocale());
    }

    @Override
    public List<String> getListBook() {
        return bookService.getListBookInfo();
    }
    ...
    public String getBookByNumber(long bookNumber) {
        ...
        return messageSource.getMessage("book.take", new String[]{String.valueOf(bookNumber)},
                localeService.getCurrentLocale());
    }
    ...
    public List<String> getListBookByAuthorName(String authorName) {
        return bookService.getListBookInfoByAuthorName(authorName);
    }
    ...
    public List<String> getListBookByGenreName(String genreName) {
        return bookService.getListBookInfoByGenreName(genreName);
    }
    ...
    @Override
    public List<String> getListCommentsByBook(long bookId) {
        return bookService.getListCommentsByBookId(bookId);
    }
}
