INSERT INTO author(id, name, birth_day)
...
VALUES (1, '12 стульев',
        'Герой романа Остап Бендер из мелкого жулика превращается в романтического героя, лишнего человека, глубоко укорененного в русской традиции.'),
...
insert into comment(id, text_comment, book_id)
values (1, 'Захватывающая история Остапа Бендера', 1),
       (2, 'Очень интересно. Рекомендую!', 3);